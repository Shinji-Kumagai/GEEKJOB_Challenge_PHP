...
function connect2MySQL(){
    try{
        $pdo = new PDO('mysql:host=localhost;dbname=Challenge_db;charset=utf8','user','password');
...
function update_profile($name, $birthday,$tell, $type, $comment, $userID) {
    $update_db = connect2MySQL();

    $update_sql = "update user_t set name = :name, birthday = :birthday, tell = :tell, type = :type, comment = :comment, newDate = :newDate where useriD = :userid";
